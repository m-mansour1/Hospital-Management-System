          ...
          <td colspan="2" height="9"> 
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="34">
              <tr align="center" bgcolor="#E3FEFF">
				   ...
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><h1><b>Laboratory Orders</b></h1>
                  </font></td>
...
<form  action="Laboratory.php" id="Laboratory" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="return ValidateForm()">
...
$sql="insert into laboratory VALUES (NULL,'".$d2."','" .$d3."','" .$d4."','" .$d5."')";
if (mysql_query($sql)){
...
<tr><TD><INPUT TYPE="hidden" NAME="laboratoryid" SIZE=20 value="<?php echo $d1;?>"></TD></tr><tr>
...
<TD><select  width="100%" NAME="doctorname"   value="<?php echo $d4;?>" class="listbox">
<option>SELECT OPTION</option>
<option>wisam</option>
</select></TD>

<td><b>TEST NAME:</b></TD>
<TD><INPUT TYPE=TEXT NAME="testname" style="height:70" style="width:200" SIZE=27 value="<?php echo $d5;?>"></TD></tr>
