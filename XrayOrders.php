...
<form  action="XrayOrders.php" id="XrayOrders" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="return ValidateForm()">
...
$sql="insert into xray VALUES (NULL,'".$d2."','" .$d3."','" .$d4."','" .$d5."')";
if (mysql_query($sql)){
...
<td><b>X-Ray NAME:</b></TD>
<TD><INPUT TYPE=TEXT NAME="xrayname" style="height:70" style="width:200" SIZE=27 value="<?php echo $d5;?>"></TD></tr>
